...
last_updated: "2026-04-04T16:32:28.027Z"
last_activity: 2026-03-30 — v2.8 milestone completed and archived
progress:
  total_phases: 7
  completed_phases: 4
  total_plans: 10
...
Milestone: v2.8 — SHIPPED 2026-03-30
Status: Complete
Last activity: 2026-03-30 — v2.8 milestone completed and archived
...
- Phase 34 added: Bugfixes & hardening — image validation timeout+retry, exponential backoff, RELEASE tag fallback, parallel image validation, deduplicate service mappings (v2.9)
...
- [Phase 34-bugfixes-hardening]: service-map.sh is single source of truth for NAME_TO_VERSION_KEY, NAME_TO_SERVICES, SERVICE_GROUPS, ALL_COMPOSE_PROFILES; double-source guard prevents re-declaration
- [Phase 34-bugfixes-hardening]: IMAGE_VALIDATION_TIMEOUT defaults 20s, overridable via env var; parallel validation uses tmpdir+md5sum; RELEASE fallback persists to file
...
Last session: 2026-04-04T15:37:03.135Z
